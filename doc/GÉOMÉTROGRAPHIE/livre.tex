...
\lstdefinestyle{hama}{%
  literate={1}{\raisebox{0.5ex}{\fbox{\textcolor{rtLightBlue400}{1}}}}{1}%
  {0}{\fbox{\textcolor{rtLightBlue900}{0}}}{1},%
  basicstyle=\ttfamily,%
}
...
\newcommand\BackgroundPic{
  \put(0,0){
    \parbox[b][\paperheight]{\paperwidth}{%
      \vfill
      \centering
      \includegraphics[width=\paperwidth,height=\paperheight]{{./ressources/company-logo.eps}%
        \vfill
      }
    }
  }
...
\fancyhead[L]{}
\fancyhead[R]{
  \includegraphics[width=1cm]{company-logo.eps}
}
...
\thispagestyle{fancy}
\lettrine{C}{ette introduction} présente en premier lieu l'incontournable ...\textbf{Giordano Bruno (1548-1600)\index{Bruno Giordano}}


\begin{figure*}[t]
  \caption[La taille des planètes]{La queue de la comète\label{billetcomete}}
  \shadowbox{\includegraphics[width=4cm]{Giordano_Bruno.eps}}
\end{figure*}
\begin{figure}[ht]
  \centering
